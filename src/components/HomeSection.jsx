    ...
    <section className='h-screen items-center'>
      <main className='h-full w-full flex flex-col justify-center items-start bg-school bg-cover'>
        <div className='m-2 w-2/4'>
          ...
          <button type='button' class='text-black bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mt-5 dark:focus:ring-yellow-900'>Forma parte!</button>
        </div>
